...
def migrate(con: sqlite3.Connection) -> None:
    con.executescript(
        ...
        CREATE TABLE IF NOT EXISTS published_action (
            ...
            target_reply_surface_score_at_reply INTEGER,
            angle_type TEXT,
            hook_type TEXT,
    ...
    signal_migrations = {
        ...
        "reply_surface_score": "INTEGER NOT NULL DEFAULT 0",
        "reply_competition_known": "INTEGER NOT NULL DEFAULT 0",
        "observed_replies": "INTEGER",
        "observed_quotes": "INTEGER",
        "views_per_reply": "REAL",
        "reply_acquisition_score": "INTEGER NOT NULL DEFAULT 0",
...
def update_signal_observation(con: sqlite3.Connection, signal_id: int, record: dict[str, Any]) -> str | None:
    ...
    defaults = {
        ...
        "reply_surface_score": 0, "reply_competition_known": 0, "reply_acquisition_score": 0,
